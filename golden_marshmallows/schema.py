...
class GoldenSchema(Schema):
    """ Subclass of marshmallow.Schema that auto-generates fields based
    ...
    def __init__(self, sqlalchemy_cls, nested_map={}, snake_to_camel=False,
                 camel_to_snake=False, new_obj=False, *args, **kwargs):
